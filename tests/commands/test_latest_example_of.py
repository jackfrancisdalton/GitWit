...
# =====================================================
# Tests for _get_list_of_matching_files
# =====================================================

def test_get_list_of_matching_files__without_dirs(patch_repo_ls):
    # Arrange
    files = [
        "app.py",
        "test_app.py",
    ...
    # Act
    result = latest._get_file_paths_matching_conditions_from_git_history(repo, ".py", None)

    # Assert
    assert result == ["app.py", "test_app.py", "src/controller.py", "src/controller.pyi"]

def test_get_list_of_matching_files__with_dirs(patch_repo_ls):
    # Arrange
    files = [
        "app.py",
        "test_app.py",
    ...
    # Act
    result = latest._get_file_paths_matching_conditions_from_git_history(repo, ".py", ["lib"])

    # Assert
    assert result == ["lib/app.py", "lib/test_lib.py"]


def test_get_list_of_matching_files__no_matches(patch_repo_ls):
    # Arrange
    files = [
        "app.js",
        "app.go"
...
# =====================================================
# Tests for _git_log_to_log_blocks
# =====================================================
...
def test_convert_git_log_to_log_blocks__single_file_and_multiple_file_commits():
    ...
    # Act
    log_blocks = latest._convert_git_log_to_blocks(raw)
