...
@pytest.mark.parametrize("date_str, expected", [
    ...
    ("2023-10-01T12:00:00", datetime(2023, 10, 1, 12, 0, tzinfo=timezone.utc)),         # Date and time
    ("2023-10-01T12:00:00Z", datetime(2023, 10, 1, 12, 0, tzinfo=timezone.utc)),        # Date and time with Zulu time
    ("2023-10-01T12:00:00+02:00", datetime(2023, 10, 1, 10, 0, tzinfo=timezone.utc)),   # Date and time with timezone offset
])
